...
class OrderViewController : UIViewController {
    ...
    override func loadView() {
        ...
        orderView.verifyBuyerButton.addTarget(self, action: #selector(didTapVerifyBuyerButton), for: .touchUpInside)
    ...
    @objc private func didTapVerifyBuyerButton() {
        delegate?.didRequestVerifyBuyer()
    }
